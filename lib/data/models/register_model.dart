...
class _RegisterScreenState extends State<RegisterScreen>
  ...
  if (_formKey.currentState!.validate()) {
    ...
    final formData = {
      ...
      "batch_id": int.tryParse(batchCtrl.text) ?? 0,
      "training_id": int.tryParse(trainingCtrl.text) ?? 0,
    };
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text("Gagal registrasi: ${response.body}")),
        );
      }
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
    ...
    return Column(
      children: [
        ...
        _inputField(
          ...
          hint: "contoh: 1",
          validator: (value) =>
              value!.isEmpty ? "Batch tidak boleh kosong" : null,
        ),
        const SizedBox(height: 15),
        ...
        _inputField(
          ...
          hint: "contoh: 1",
          validator: (value) =>
              value!.isEmpty ? "Training ID tidak boleh kosong" : null,
        ),
        const SizedBox(height: 15),
